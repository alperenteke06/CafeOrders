...
{
    public static async Task SeedAsync(CafeManagementDbContext dbContext, CancellationToken cancellationToken = default)
    {
    ...
    private static async Task EnsureDefaultTablesAsync(CafeManagementDbContext dbContext, CancellationToken cancellationToken)
    {
