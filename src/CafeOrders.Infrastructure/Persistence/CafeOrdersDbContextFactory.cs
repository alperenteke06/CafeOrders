...
public sealed class CafeOrdersDbContextFactory : IDesignTimeDbContextFactory<CafeOrdersDbContext>
{
    public CafeOrdersDbContext CreateDbContext(string[] args)
    {
        ...
        var connectionString = "Server=192.168.11.24\\SQLEXPRESS;Database=CafeOrders;User Id=sa;Password=sa@Alperen123!;TrustServerCertificate=True;MultipleActiveResultSets=True";
