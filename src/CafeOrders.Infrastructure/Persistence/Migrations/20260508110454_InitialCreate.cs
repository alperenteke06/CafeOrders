        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OrderAcceptedMessage = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    OrderRejectedMessage = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ClientInfoBoxMessage = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
